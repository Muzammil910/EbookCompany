					...
					<div class="book-wrap d-lg-flex">
						...
						<div class="img d-flex justify-content-end" style="background-image: url(images/<?php echo $row['book_image'] ?>);">
							<div class="in-text">
									...
									<a href="add_to_cart.php?cartID=<?php echo $row['book_id'] ?>" class="icon d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="left" title="Add to cart">
